  ...
  <div id="navbarBasicExample" class="navbar-menu">
    <div class="navbar-start">
      ...
      <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-dropdown">
          <a href="index.php?vista=ingresarPacienteForm" class="navbar-item">
            Ingresar pacientes
          </a>
          <a href="index.php?vista=listaDePacientes" class="navbar-item is-selected">
            Lista de pacientes
          </a>
    ...
    <div class="navbar-end">
      <div class="navbar-item">
        <div class="buttons">
          <a href="index.php?vista=registrarUsuarioForm" class="button is-primary is-rounded">
            <strong>Sign up</strong>
          </a>
          <a href="index.php?vista=iniciarSesion" class="button is-light is-rounded">
            Log in
          </a>
        </div>
      </div>
